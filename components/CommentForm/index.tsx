    ...
    return (
        <div className={styles.commentForm} style={{width: width}}>
            <Form onSubmit={onSubmit}>
                <input className="commentForm-commentorName" value={name} onChange={(e) => setName(e.target.value)} type="text" placeholder="Nhập tên của bạn..."/> <br/>
                <textarea 
                ...
                /> <br/>
                <button className="commentForm-btn" disabled={isTextareaDisabled}>{submitLabel}</button>
                {hasCancelButton && (
                    <button
                    type="button"
